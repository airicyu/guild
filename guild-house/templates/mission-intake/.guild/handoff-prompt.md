...
- [ ] Read the skills bank catalogs (`../../skills-bank/built-in/catalog.md` and `../../skills-bank/custom/catalog.md`); follow `mission-management/skills-bank.md` to wire via `.agents/skills/wire-skills-from-bank/wire.sh …` **before explore**
