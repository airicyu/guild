...
2. **Round 0 — wire skills** — read the skills bank catalogs (`../../skills-bank/built-in/catalog.md` and `../../skills-bank/custom/catalog.md`); follow `mission-management/skills-bank.md`; run `.agents/skills/wire-skills-from-bank/wire.sh …` before explore/draft
