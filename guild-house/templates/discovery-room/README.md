...
Guild master **Approve** — either Web UI / `POST /discoveries/:id/approve`, or intake lead runs `tools/approve.sh` when guild master approves in attach or inbox. Copies `artifacts/missions/*` to parking and removes the idea from the board.
