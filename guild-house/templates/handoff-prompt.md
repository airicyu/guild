...
- [ ] Read `../../skills-bank/catalog.md` (pick skills); follow `mission-management/skills-bank.md` to wire via `.claude/skills/wire-skills-from-bank/wire.sh …` **before evaluator**
