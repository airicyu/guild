...
Covers: full close-out through Phase 3 — approve, release (`status: released`), retro (`workflow-report.md`), `retrospective_complete` before `mission_complete`; reject; abort. No live PO — channel degraded.
